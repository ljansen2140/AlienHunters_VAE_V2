...
x = layers.Conv2D(64, kernel_size=(4,4), padding='same', activation='relu', strides=(4,4), name='Conv_Layer_2')(x)
#x = layers.MaxPooling2D((4,4), padding='same', name='Pooling_Layer_2')(x)

#Convolutional Layer 3
x = layers.Conv2D(64, kernel_size=(2,2), padding='same', activation='relu', strides=(2,2), name='Conv_Layer_3')(x)
...
x = layers.Dense(64 * 64 * 64, name='Upscale_Layer')(x)
...
x = layers.Conv2DTranspose(64, kernel_size=(2,2), padding='same', strides=(2,2), activation='relu', name='TP_Layer_3')(x)

#x = layers.UpSampling2D((4,4), name="UpSample_Layer_2")(x)
x = layers.Conv2DTranspose(64, kernel_size=(4,4), padding='same', strides=(4,4), activation='relu', name='TP_Layer_2')(x)
